...
public class ComentarioDoctorAdapter extends RecyclerView.Adapter<ComentarioDoctorAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.calificacion.setRating(4);
        //holder.calificacion.setRating((float) comentarioDoctorList.get(position).getCalificacion());
        //holder.calificacion.setRating(Float.parseFloat(comentarioDoctorList.get(position).getCalificacion())/20);
